...
class Loading {
    ...
    execLoading: (options?: LoadingOptions) => void
    execClose: () => void

    constructor(execLoading: (options?: LoadingOptions) => void, execClose: () => void) {
...
export const loadingObject = {
    ...
    layout: new Loading(
        (options?: LoadingOptions) =>
            (loadingInstance.layout = ElLoading.service(Object.assign({target: '#app-main'}, options))),
